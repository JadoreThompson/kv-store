...
import com.zenz.kvstore.responses.RedirectResponse;
...
public class RaftCommandHandlerV2 implements BaseCommandHandler {
    private final KVStore store;
    private final RaftManager manager;

    public RaftCommandHandlerV2(KVStore store, RaftManager manager) {
        this.store = store;
